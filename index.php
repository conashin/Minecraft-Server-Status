...
$host = "mc310.o16.dev"; //设置服务器域名或 IP
$port = "25565"; //设置服务器端口，可以直接用服务器的链接端口，也可以使用query端口（UDP协议）
$name = '310 Minecraft Server'; // 服务器名字，会显示在标签页的标题和网站打头的大标题处
$iconlink = 'https://conashin-b2.o16.dev/20221221_125634.jpg'; // 网站图标链接，可以使图片格式（.png/.jpg/etc.）或者是ico图标，用绝对路径或相对路径均可
...
$imagelink = 'https://conashin-b2.o16.dev/20221223_125507.jpg'; // 图片链接，会显示在服务器信息右边的圈圈里
/*
$host = $_GET["host"];
$port = $_GET["port"];
								...
								<div class="spotlight">
									<div class="content">
										...
										<p>IP 或域名：<font color="#2a6c0f"><?php echo $host; ?></font>
											...
											<br>埠：<font color="#2a6c0f"><?php echo $port; ?></font></p>
										<p>MOTD：<font color="#2a6c0f"><?php echo $motd; ?></font>
											<br>清除顏色後的 MOTD：<font color="#2a6c0f"><?php echo $clean_motd; ?></font>
											<br>顏色轉會為 HTML 的 MOTD：<font color="#2a6c0f"><?php echo $html_motd; ?></font></p>
										<p>平台：<font color="#2a6c0f"><?php echo $platform; ?></font>
											<br>遊戲類型：<font color="#2a6c0f"><?php echo $gametype; ?></font></p>
										<p>相容遊戲版本：<font color="#2a6c0f"><?php echo $version; ?></font>
											<br>伺服器啟用的核心或軟體：<font color="#2a6c0f"><?php echo $software; ?></font></p>
										<p>最大玩家數：<font color="#2a6c0f"><?php echo $players_max; ?></font>
											<br>線上玩家數：<font color="#2a6c0f"><?php echo $players_online; ?></font></p>
										<p>使用的查詢方式：<font color="#2a6c0f"><?php echo $agreement; ?></font>
											<br>查詢花費：<font color="#2a6c0f"><?php echo $processed; ?></font></p>
										<!-- <hr> -->
										<h3>目前線上玩家 <font color="#2a6c0f"><?php echo $players_online; ?></font>/<font color="#2a6c0f"><?php echo $players_max; ?></font></h3>
